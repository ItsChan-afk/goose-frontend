...
const Every = () => {
  ...
  return (
    <div className="grid grid-cols-4 gap-[5rem] m-10">
      {geese.map((goose) => (
        <div key={goose.slug} className="col-span-1 border-2 border-biege-700 shadow-xl rounded-xl bg-white transition hover:shadow-orange-500 hover:shadow-lg hover:border-orange-500">
          <img
            src={goose.image}
            alt={goose.name}
